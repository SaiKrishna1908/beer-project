...
@SpringBootTest
class BeerOrderRestControllerTest extends BaseIT {
...
//    class createOrderTests {
    ...
    void pickUpOrderNotAuth() throws Exception {
        ...
        mockMvc.perform(put(API_ROOT+beerOrder.getCustomer().getId()+"/orders/"+beerOrder.getId()+"/pickup"))
                .andExpect(status().isUnauthorized());
